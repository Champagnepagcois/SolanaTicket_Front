        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-12">
              <h2 className="text-white mb-lg-0">SolanaTicket</h2>
            </div>
            ...
            {/*<div className="col-lg-6 col-12 d-flex justify-content-lg-end align-items-center">
              <ul className="social-icon d-flex justify-content-lg-end">
                <li className="social-icon-item">
                  <Link to="./index" className="social-icon-link">
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6 col-12 mb-4 pb-2">
            ...
            <ul className="site-footer-links">
              <li className="site-footer-link-item">
                <Link to="./index" className="site-footer-link">
                  Index
                </Link>
              </li>
          ...
          <div className="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
            <h5 className="site-footer-title mb-3">¿Tienes alguna duda?</h5>

            <p className="text-white d-flex">
              <a
                href="mailto:tmarlonrodriguez2b@gmail.com"
                className="site-footer-link"
              >
                tmarlonrodriguez2b@gmail.com
              </a>
            </p>
          ...
          <div className="col-lg-3 col-md-6 col-11 mb-4 mb-lg-0 mb-md-0">
            ...
            <a className="link-fx-1 color-contrast-higher mt-3" href="https://goo.gl/maps/kBfJDvNNvnfXN4QQ7">
              <span>Our Maps</span>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-12 mt-5">
              <p className="copyright-text">SolanaTicket</p>
            </div>
